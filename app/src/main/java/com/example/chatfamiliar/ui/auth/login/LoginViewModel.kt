...
class LoginViewModel : ViewModel() {
    ...
    var password by mutableStateOf("")
        private set
    var errorVisual by mutableStateOf<String?>(
        null)
        private set
    ...
    fun iniciarSesion(alTenerExito: () -> Unit,
        ...
        cargando = true
        errorVisual = null
        authRepository.iniciarSesion(correo = correoLimpio,
    ...
    private fun validarFormulario(correo: String):
            Boolean {
        if (correo.isBlank() ||
            password.isBlank()) {
            errorVisual = "Por favor, " +
    ...
    private fun obtenerMensajeError(excepcion:
                                    Throwable):
            String {
        return when (excepcion) {
            ...
            is FirebaseAuthInvalidUserException ->
                "Correo o contraseña incorrectos. Verifica " +
                        "tus datos."
